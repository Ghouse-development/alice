          ...
          <div className="col-span-3">
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="bg-white rounded-xl border-2 border-gray-200 p-6 shadow-sm">
                ...
                <div className="text-4xl font-bold tabular-nums" style={{ color: useBattery ? SCENARIO_COLORS.pvBatt : SCENARIO_COLORS.pv }}>
                  ¥{formatNumber(useBattery ? metrics.firstYearBenefitBatt : metrics.firstYearBenefit)}
              ...
              <div className="bg-white rounded-xl border-2 border-gray-200 p-6 shadow-sm">
                ...
                <div className="flex gap-3 justify-center">
                  {[
                    { label: '10年', value: useBattery ? metrics.cumulative10Batt : metrics.cumulative10 },
                    { label: '15年', value: useBattery ? metrics.cumulative15Batt : metrics.cumulative15 },
                    { label: '20年', value: useBattery ? metrics.cumulative20Batt : metrics.cumulative20 },
                  ].map(item => (
              ...
              <div className="bg-white rounded-xl border-2 border-gray-200 p-6 shadow-sm">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-2xl font-bold" style={{ color: SCENARIO_COLORS.pvBatt }}>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-5 shadow-sm">
            ...
            <div className="mt-4 pt-4 border-t text-xs text-gray-600">
              <div className="space-y-1">
                <div>売電: 1-4年={settings.sell_y1_4}円 5-10年={settings.sell_y5_10}円 11年〜={settings.sell_after11}円</div>
                <div>劣化率: {(settings.degrade * 100).toFixed(1)}%/年</div>
                <div>パワコン: {settings.pc_cycle}年毎 {formatNumber(settings.pc_cost)}円</div>
                {useBattery && (
                  <div>蓄電池: 初期{formatNumber(settings.batt_init)}円 更新{settings.batt_cycle}年毎</div>
                )}
              </div>
            </div>
          </div>
