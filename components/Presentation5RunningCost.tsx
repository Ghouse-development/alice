            ...
            <div className={`rounded-lg border h-full ${
              ...
              <div className="p-4 space-y-4">
                <div className={`p-4 rounded-lg border ${
                  ...
                  }`}>{paybackPeriodPattern2 > 0 ? paybackPeriodPattern2 : '---'}年</p>
                </div>
                <div className={`p-4 rounded-lg border ${
                  isDark ? 'bg-gray-800/50 border-gray-700' : 'bg-gray-100 border-gray-300'
                }`}>
                  ...
                  <p className={`text-2xl font-bold ${
                    isDark ? 'text-yellow-400' : 'text-yellow-600'
                  }`}>{paybackPeriodPattern3 > 0 ? paybackPeriodPattern3 : '---'}年</p>
                </div>
                <div className={`p-4 rounded-lg border ${
                  isDark ? 'bg-gray-800/50 border-gray-700' : 'bg-gray-100 border-gray-300'
                }`}>
                  ...
                  <p className={`text-2xl font-bold ${
                    isDark ? 'text-white' : 'text-gray-900'
                  }`}>¥{(lifetimeSimulation.initialInvestments.solarBattery / 10000).toFixed(0)}万円</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className={`rounded-lg border h-full ${
              ...
              <div className="p-4 space-y-4">
                <div className={`p-4 rounded-lg border ${
                  ...
                  <p className={`text-2xl font-bold ${
                    isDark ? 'text-red-400' : 'text-red-600'
                  }`}>¥{(finalYear.pattern1 / 10000).toFixed(0)}万円</p>
                </div>
                <div className={`p-4 rounded-lg border ${
                  isDark ? 'bg-gray-800/50 border-gray-700' : 'bg-gray-100 border-gray-300'
                }`}>
                  ...
                  <p className={`text-2xl font-bold ${
                    isDark ? 'text-yellow-400' : 'text-yellow-600'
                  }`}>¥{(finalYear.pattern3 / 10000).toFixed(0)}万円</p>
                </div>
          ...
          <div className="grid grid-cols-4 gap-6">
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-purple-600 mb-2">
                {((totalSavingsPattern3 / lifetimeSimulation.initialInvestments.solarBattery) * 100).toFixed(1)}%
              </div>
              <p className={`text-sm ${
                isDark ? 'text-gray-300' : 'text-gray-600'
              }`}>投資収益率（ROI）</p>
